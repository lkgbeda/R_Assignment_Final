...
The uses filter () to filter df_maize_sorted_incre to keep only rows where the Chromosome column has the value "multiple" and saves the result in df_multiple.  
Similarly silters df_maize_sorted_incre to keep only rows where the Chromosome column has the value "unknown".
...
dentifies SNPs where Chromosome is labeled as "multiple" or "unknown".
...
terates over chromosomes 1 to 10.  
